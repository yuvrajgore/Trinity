	...
	success : function(data) {
		 ...
		 var count=1;
	        $.each(data, function (i, item) {
	        	...
	        	'</td><td>' + item.projectDescription + '</td>'+'<td><a class="btn btn-primary" href="#" onclick="openProject('+item.projectId+')">Open Project</a></td></tr>';
	        });
...
function openProject(id){
    ...
    mapForm.method = "POST";
    mapForm.action = "openProject";

    var mapInput = document.createElement("input");
    mapInput.name = "projectId";
